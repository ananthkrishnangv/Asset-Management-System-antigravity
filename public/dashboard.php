...
$categoryJson = json_encode($itemsByCategory);
$monthlyJson = json_encode($monthlyEntries);
$conditionJson = json_encode($itemsByCondition);
...
<?php if (Auth::isSupervisor()): ?>
    <div class="mb-8 bg-gradient-to-r from-slate-800 to-slate-900 rounded-2xl p-6">
...
// Condition Chart
const conditionData = $conditionJson;
